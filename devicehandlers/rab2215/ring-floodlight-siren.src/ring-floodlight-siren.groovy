 ...
 *
 *  I used https://github.com/philgituser/smartthings/tree/master/devicetypes as a guide to build the requests.
 *  Author: Randall
 *
 */
metadata {
    definition (name: "Ring Spotlight Siren", namespace: "rab2215", author: "cletus maximus") {
        capability "Actuator"
        capability "Switch"
        capability "Sensor"
    }
